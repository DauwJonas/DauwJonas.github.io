(function() {
    ...
    for (let i = 0; i < allListItemsEl.length; i++) {
        ...
        listItemEl.innerHTML = `<a href="${data.a}"target="_blank"class="img"><img src="${data.img}"></a><div><h4><a href="${data.a}"target="_blank">${data.h4}</a></h4><p>${data.p}</p><a href="${data.a}"target="_blank">${data.h4}</a></div>`;
    }
})();